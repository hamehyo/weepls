$(function (){
    ...
    //const section = document.querySelector('.fp-scrollable'); // Select the scrollable section
    $(".web_inner").on('scroll', function() {
        const scrollPosition = $(".web_inner").scrollTop;
